  ...
  return (
    <div className="bg-gradient-to-r from-cyan-100 to-blue-200 dark:from-slate-900 dark:to-slate-900 h-[calc(100vh-70px)] flex items-center justify-center">
      ...
      >
        ...
        <button
          className="hover:border-primary-700 border bg-white text-primary-700 font-medium font-Poppins px-4 py-2 rounded-md transition duration-300 focus:outline-none focus:border-primary-700 focus:ring focus:ring-primary-200 w-full flex gap-4 justify-center text-sm lg:text-base"
